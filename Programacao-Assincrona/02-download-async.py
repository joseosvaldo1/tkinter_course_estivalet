...
# No Tkinter o mainloop() deve ser sempre executado na thread 
# principal, pois é responsável por gerenciar eventos e atualizar 
# a interface gráfica.

# Se sua aplicação possui uma operação de longa duração, ela deve 
# ser executada em uma thread separada. Caso contrário, a interface 
# pode travar ou se tornar não responsiva.

# Então, para criar e controlar threads em aplicações TK, nós vamos 
# utilizar o módulo threading, que faz parte da biblioteca padrão 
# Python.
