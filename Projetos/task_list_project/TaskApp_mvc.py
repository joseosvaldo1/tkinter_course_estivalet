...
class TaskView:
    ...
    def add_task_to_view(self, task_text):
        ...
        task_checkbox = tk.Checkbutton(
            task_frame, 
            variable=task_var, 
            command=lambda: self.controller.toggle_task(
                task_checkbox, 
                task_label, 
                task_var), 
            bg="#ffffff")
        ...
        edit_button = tk.Button(
            ...
            command=lambda: self.controller.open_edit_window(task_label), 
            bd=0, 
            bg="#ffffff")
        ...
        delete_button = tk.Button(
            ...
            command=lambda: self.controller.delete_task(task_frame), 
            bd=0, 
            bg="#ffffff")
